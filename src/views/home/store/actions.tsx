...
//   dispatch(createAction(ActionTypes.COMMON_USER_TOKEN_START)())
//   return Service.pagodaLogin(params)
//   .then(res => {
//     setCookie('quickbi_token', res.token)
//     dispatch(createAction(ActionTypes.COMMON_USER_TOKEN_SUCCESS)(res))
//     return res.token
//   })
//   .catch(e => {
//     dispatch(createAction(ActionTypes.COMMON_USER_TOKEN_FAIL)())
//   })
// }
...
//     dispatch(createAction(ActionTypes.COMMON_USER_TOKEN_SUCCESS)(token))
//     return token
//   })
//   .catch(e => {
//     dispatch(createAction(ActionTypes.COMMON_USER_TOKEN_FAIL)())
...
//   dispatch(createAction(ActionTypes.COMMON_USER_CURRENT)(user))
//   return user
// }
...
//   dispatch(createAction(ActionTypes.COMMON_USER_PRIVILIGE_PENDING)())
//   // 测试
//   return Service.loadUserInfoMixedAccess()
//   .then(({ current, permissions }) => {
//     dispatch(createAction(ActionTypes.COMMON_USER_PRIVILIGE_SUCCESS)(permissions))
//     dispatch(createAction(ActionTypes.COMMON_USER_CURRENT)(current))
//   })
//   .catch((e) => {
//     dispatch(createAction(ActionTypes.COMMON_USER_PRIVILIGE_FAIL)())
//     dispatch(createAction(ActionTypes.COMMON_USER_CURRENT)())
//   })
// }
